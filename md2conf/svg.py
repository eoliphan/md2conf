...
def _extract_dimensions_from_root(root: ET._Element) -> tuple[Optional[int], Optional[int]]:
    """
...
def get_svg_dimensions(path: Path) -> tuple[Optional[int], Optional[int]]:
    """
...
def get_svg_dimensions_from_bytes(data: bytes) -> tuple[Optional[int], Optional[int]]:
    """
...
def _parse_svg_length(value: str) -> Optional[int]:
    """
    ...
    if normalized_unit is None or normalized_unit == "px":
        pixels = num
    elif normalized_unit == "pt":
        pixels = num * 96 / 72  # 1pt = 1/72 inch
    elif normalized_unit == "in":
        pixels = num * 96
    elif normalized_unit == "cm":
        pixels = num * 96 / 2.54
    elif normalized_unit == "mm":
        pixels = num * 96 / 25.4
    elif normalized_unit == "pc":
        pixels = num * 96 / 6  # 1pc = 12pt = 1/6 inch
    elif normalized_unit == "em":
        pixels = num * 16  # assume 16px base font
    elif normalized_unit == "ex":
...
def _parse_viewbox(viewbox: str) -> tuple[Optional[int], Optional[int]]:
    """
